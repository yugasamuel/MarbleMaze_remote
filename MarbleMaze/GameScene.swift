...
//  MarbleMaze
//
//  Created by Yuga Samuel on 13/10/23.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        scoreLabel.position = CGPoint(x: 24, y: 38)
    ...
    func createBlock(on position: CGPoint) {
    ...
    func createStar(on position: CGPoint) {
    ...
    func createFinishFlag(on position: CGPoint) {
